...
# The first thing you need to configure
# is which modules you need in your app.
# The default is nothing which will include only core features
# (password encryption, login/logout).
# Available submodules are: :user_activation, :http_basic_auth, :remember_me,
# :reset_password, :session_timeout,
# :brute_force_protection, :activity_logging, :external
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.user_config do |user|
    ...
    # the one which is used until an encrypted one is generated.
    # Default: `:password`
    #
    ...
    # WARNING: If used for users' passwords,
    # changing this key will leave passwords undecryptable!
    # Default: `nil`
    #
    # user.encryption_key =
    ...
    # hammering protection, how long in seconds to wait
